...
module.exports = (shepherd) => {
  shepherd.kvEncode = (data) => {
    ...
    console.log(data.content.body.length);
    console.log(data.content.body);
    console.log(kvBuf[6]);
    console.log(kvBuf[6].toString());
  ...
  shepherd.kvDecode = (hex, fromTx) => {
    shepherd.log(Buffer.from(hex, 'hex').toString());
    ...
    shepherd.log('kv buffer');
    shepherd.log(kvBuf, true);

    for (let i = 0; i < kvBuf.length; i++) {
      shepherd.log(`kv buffer ${i}, ${kvBuf[i].length} bytes`);
      shepherd.log(`kv buffer -> string ${kvBuf[i].length} bytes`);
  ...
  shepherd.get('/electrum/kv/test/decode', (req, res, next) => {
    ...
    //const kvtest = '';
    //const kvtest = '';
