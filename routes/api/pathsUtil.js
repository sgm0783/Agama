...
const pathsDaemons = (api) => {
  ...
  switch (os.platform()) {
    case 'darwin':
      ...
      api.veruscliBin = path.join(__dirname, '../../assets/bin/osx/verusd/komodo-cli'),
    ...
    case 'linux':
      ...
      api.veruscliBin = path.join(__dirname, '../../assets/bin/linux64/verusd/komodo-cli'),
    ...
    case 'win32':
      ...
      api.veruscliBin = path.join(__dirname, '../../assets/bin/win64/verusd/komodo-cli.exe'),
